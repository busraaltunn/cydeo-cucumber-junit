...
public class BrowserUtils {
    ...
    /**
     * This method will accept a dropdown as a WebElement and return all the option's text in a List of String
     ...
     */
    public static  void clickRadioButon(List<WebElement> radioButtons, String attributeValue){
